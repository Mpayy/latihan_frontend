...
export default function Home() {
  ...
  // Placeholder avatar jika profile_url null
          ...
          <div className="d-flex align-items-start gap-3">
            <img
              src={
                ...
                defaultAvatar(currentUser.name || "me")
              }
              alt="my-avatar"
            ...
            <div className="flex-grow-1">
              ...
              {(imagePreview || file) && (
                <div className="mt-3 position-relative bg-light p-2 rounded border border-dashed text-center">
                  ...
                  {file && (
                    <div
                      className="d-flex align-items-center justify-content-center gap-2 p-3 bg-white rounded border mx-auto"
              ...
              <div className="d-flex justify-content-between align-items-center mt-3 pt-2 border-top">
                ...
                >
                  {btnLoading ? <Spinner size="sm" /> : "Kirim"}
                </Button>
              </div>
            </div>
          </div>
      ...
      <div className="posts-list mt-4">
        {loading ? (
          ...
          posts.map((post) => (
            <div
              key={post.id}
              className="post-card mb-3 shadow-sm border-light"
            >
      ...
      >
        ...
        <Modal.Body className="pt-3">
          <Form onSubmit={handleUpdatePost}>
            ...
            {(editImagePreview ||
              editFile ||
              (editPostData && editPostData.file_url)) && (
                ...
                {(editFile || (editPostData && editPostData.file_url)) && (
                  <div className="d-flex align-items-center justify-content-center gap-2 p-2 bg-white rounded border shadow-sm mt-2">
                    ...
                    >
                      {editFile
                        ? editFile.name
                        : editPostData.file_url.split("/").pop() ||
                          "File terlampir"}
                    </span>
                  </div>
                )}
            ...
            {commentLoading ? (
              ...
              comments.map((comment) => (
                ...
                >
                  ...
                  <div className="flex-grow-1">
                    <div
                      className="bg-white p-2 rounded-3 shadow-sm border inline-block"
